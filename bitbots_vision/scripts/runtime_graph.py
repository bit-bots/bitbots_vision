...
labels   =  ['FCN_8',               'FCN_8_VGG',           'FCN_8_MOBILENET',       'FCN_32',               'FCN_32_VGG',           'FCN_32_MOBILENET',     'MOBILENET_UNET',       'VGG_UNET',             'UNET_MINI',            'UNET',                 'MOBILENET_SEGNET',     "SEGNET",               'VGG_SEGNET',           'VGG_PSPNET',           'PSPNET',               'MODEL_BASED']
