...
default_config['checkpoints_base_path'] = "/srv/ssd_nvm/deep_field/models/foo/"  # Path to store checkpoints
...
models['fcn_8_vgg'] = {}
models['fcn_32_vgg'] = {}
models['fcn_8_mobilenet'] = {'input_width': 224, 'input_height': 224}
models['fcn_32_mobilenet'] = {'input_width': 224, 'input_height': 224}
...
blacklist_models['fcn_8_resnet50'] = {}  # CPU and ValueError: Negative dimension size caused by subtracting 7 from 6 for 'avg_pool/AvgPool' (op: 'AvgPool') with input shapes: [?,6,6,2048].
blacklist_models['fcn_32_resnet50'] = {}  # CPU and ValueError: Negative dimension size caused by subtracting 7 from 6 for 'avg_pool/AvgPool' (op: 'AvgPool') with input shapes: [?,6,6,2048].
